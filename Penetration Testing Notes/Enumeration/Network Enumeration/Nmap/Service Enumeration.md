...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV --stats-every=5s
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV -v 
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.28 -p- -sV -Pn -n --disable-arp-ping --packet-trace
...
```shell-session
0xNecr0@htb[/htb]$ sudo tcpdump -i eth0 host 10.10.14.2 and 10.129.2.28
...
```shell-session
0xNecr0@htb[/htb]$  nc -nv 10.129.2.28 25
