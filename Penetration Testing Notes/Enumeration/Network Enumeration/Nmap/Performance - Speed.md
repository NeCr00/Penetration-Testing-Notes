...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.0/24 -F
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --initial-rtt-timeout 50ms --max-rtt-timeout 100ms
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.0/24 -F | grep "/tcp" | wc -l
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.0/24 -F --max-retries 0 | grep "/tcp" | wc -l
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.default
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.minrate300 --min-rate 300
...
```shell-session
0xNecr0@htb[/htb]$ cat tnet.default | grep "/tcp" | wc -l
...
```shell-session
0xNecr0@htb[/htb]$ cat tnet.minrate300 | grep "/tcp" | wc -l
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.0/24 -F -oN tnet.T5 -T 5
...
```shell-session
0xNecr0@htb[/htb]$ cat tnet.T5 | grep "/tcp" | wc -l
...
More information about scan performance we can find at [https://nmap.org/book/man-performance.htm](https://nmap.org/book/man-performance.html)