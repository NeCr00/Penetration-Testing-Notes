...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap <target> -sC
```
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap <target> --script <category>
```
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap <target> --script <script-name>,<script-name>,...
```
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.28 -p 25 --script banner,smtp-commands
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -A
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.2.28 -p 80 -sV --script vuln 
