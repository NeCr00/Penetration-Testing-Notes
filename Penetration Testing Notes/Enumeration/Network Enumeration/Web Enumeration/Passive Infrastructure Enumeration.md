...
```shell-session
0xNecr0@htb[/htb]$ go install github.com/tomnomnom/waybackurls@latest
```
...
```shell-session
0xNecr0@htb[/htb]$ waybackurls -dates https://facebook.com > waybackurls.txt
0xNecr0@htb[/htb]$ cat waybackurls.txt
