...
```shell-session
0xNecr0@htb[/htb]$ nmap -sV -sC 10.129.201.248 -p3389 --script rdp*
...
```shell-session
0xNecr0@htb[/htb]$ nmap -sV -sC 10.129.201.248 -p3389 --packet-trace --disable-arp-ping -n
...
```shell-session
0xNecr0@htb[/htb]$ git clone https://github.com/CiscoCXSecurity/rdp-sec-check.git && cd rdp-sec-check
0xNecr0@htb[/htb]$ ./rdp-sec-check.pl 10.129.201.248
...
```shell-session
0xNecr0@htb[/htb]$ xfreerdp /u:cry0l1t3 /p:"P455w0rd!" /v:10.129.201.248
