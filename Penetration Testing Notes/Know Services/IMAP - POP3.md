...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.14.128 -sV -p110,143,993,995 -sC
...
```shell-session
0xNecr0@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user user:p4ssw0rd
...
```shell-session
0xNecr0@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user cry0l1t3:1234 -v
...
```shell-session
0xNecr0@htb[/htb]$ openssl s_client -connect 10.129.14.128:pop3s
...
```shell-session
0xNecr0@htb[/htb]$ openssl s_client -connect 10.129.14.128:imaps
