...
```shell-session
0xNecr0@htb[/htb]$ cat /etc/snmp/snmpd.conf | grep -v "#" | sed -r '/^\s*$/d'
...
```shell-session
0xNecr0@htb[/htb]$ snmpwalk -v2c -c public 10.129.14.128
...
```shell-session
0xNecr0@htb[/htb]$ sudo apt install onesixtyone
0xNecr0@htb[/htb]$ onesixtyone -c /opt/useful/SecLists/Discovery/SNMP/snmp.txt 10.129.14.128
...
```shell-session
0xNecr0@htb[/htb]$ sudo apt install braa
0xNecr0@htb[/htb]$ braa <community string>@<IP>:.1.3.6.*   # Syntax
0xNecr0@htb[/htb]$ braa public@10.129.14.128:.1.3.6.*
