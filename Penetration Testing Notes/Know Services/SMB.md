...
```shell-session
0xNecr0@htb[/htb]$ cat /etc/samba/smb.conf | grep -v "#\|\;" 
...
```shell-session
0xNecr0@htb[/htb]$ smbclient -N -L //10.129.14.128
...
```shell-session
0xNecr0@htb[/htb]$ smbclient //10.129.14.128/notes
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.14.128 -sV -sC -p139,445
...
```shell-session
0xNecr0@htb[/htb]$ rpcclient -U "" 10.129.14.128
...
```shell-session
0xNecr0@htb[/htb]$ for i in $(seq 500 1100);do rpcclient -N -U "" 10.129.14.128 -c "queryuser 0x$(printf '%x\n' $i)" | grep "User Name\|user_rid\|group_rid" && echo "";done
...
```shell-session
0xNecr0@htb[/htb]$ samrdump.py 10.129.14.128
...
```shell-session
0xNecr0@htb[/htb]$ smbmap -H 10.129.14.128
...
```shell-session
0xNecr0@htb[/htb]$ crackmapexec smb 10.129.14.128 --shares -u '' -p ''
...
```shell-session
0xNecr0@htb[/htb]$ git clone https://github.com/cddmp/enum4linux-ng.git
0xNecr0@htb[/htb]$ cd enum4linux-ng
0xNecr0@htb[/htb]$ pip3 install -r requirements.txt
```
...
```shell-session
0xNecr0@htb[/htb]$ ./enum4linux-ng.py 10.129.14.128 -A
