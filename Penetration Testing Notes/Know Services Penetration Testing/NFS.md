...
```shell-session
0xNecr0@htb[/htb]$ cat /etc/exports 
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
0xNecr0@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
0xNecr0@htb[/htb]$ mkdir target-NFS
0xNecr0@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
0xNecr0@htb[/htb]$ cd target-NFS
...
```shell-session
0xNecr0@htb[/htb]$ cd ..
0xNecr0@htb[/htb]$ sudo umount ./target-NFS
```