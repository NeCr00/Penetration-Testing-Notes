...
```shell-session
0xNecr0@htb[/htb]$ sudo apt install vsftpd 
```
...
```shell-session
0xNecr0@htb[/htb]$ cat /etc/vsftpd.conf | grep -v "#"
```
...
```shell-session
0xNecr0@htb[/htb]$ cat /etc/ftpusers
...
```shell-session
0xNecr0@htb[/htb]$ ftp 10.129.14.136
...
```shell-session
0xNecr0@htb[/htb]$ ls | grep Notes.txt
...
```shell-session
0xNecr0@htb[/htb]$ wget -m --no-passive ftp://anonymous:anonymous@10.129.14.136
...
```shell-session
0xNecr0@htb[/htb]$ touch testupload.txt
```
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap --script-updatedb
...
```shell-session
0xNecr0@htb[/htb]$ find / -type f -name ftp* 2>/dev/null | grep scripts
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap -sV -p21 -sC -A 10.129.14.136
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap -sV -p21 -sC -A 10.129.14.136 --script-trace
...
```shell-session
0xNecr0@htb[/htb]$ nc -nv 10.129.14.136 21
```

  Service Interaction

```shell-session
0xNecr0@htb[/htb]$ telnet 10.129.14.136 21
```
...
```shell-session
0xNecr0@htb[/htb]$ openssl s_client -connect 10.129.14.136:21 -starttls ftp
