...
```shell-session
0xNecr0@htb[/htb]$ cat /etc/postfix/main.cf | grep -v "#" | sed -r "/^\s*$/d"
...
```shell-session
0xNecr0@htb[/htb]$ telnet 10.129.14.128 25
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.14.128 -sC -sV -p25
...
```shell-session
0xNecr0@htb[/htb]$ sudo nmap 10.129.14.128 -p25 --script smtp-open-relay -v
